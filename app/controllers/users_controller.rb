  ...
  before_action :authenticate_user!, only: [:manage_users, :donations, :update_user_role, :change_image]
  before_action :set_user, only: [:show, :authorize_user, :donations, :update_user_role, :change_image]
